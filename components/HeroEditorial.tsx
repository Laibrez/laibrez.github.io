      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-[minmax(300px,450px)_1fr] gap-12 lg:gap-24 items-center relative z-10 px-4 md:px-12 lg:px-20 max-w-[1600px] mx-auto">
        ...
        <div className="order-1 lg:order-2 flex flex-col items-center lg:items-start text-center lg:text-left pt-8 lg:pt-0 max-w-full">
          <div className="relative inline-block mb-12 md:mb-16 px-4 lg:px-0 max-w-full">
            ...
            <span className="font-great-vibes text-[clamp(2.8rem,11vw,9.5rem)] font-normal leading-none text-[#BAFF39] absolute -bottom-[0.8em] md:-bottom-[0.9em] right-1/2 lg:right-0 translate-x-1/2 lg:translate-x-0 lg:-right-4 xl:-right-12 z-20 whitespace-nowrap drop-shadow-[0_0_80px_rgba(186,255,57,0.5)] animate-fade-up [animation-delay:800ms] scale-100 md:scale-110">
              Bravo Juárez
            </span>
          </div>
